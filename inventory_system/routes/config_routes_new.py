...
def init_config_routes(app):
    ...
    @app.route('/api/config/subgroups', methods=['GET'])
    @login_required
    def get_config_subgroups():
    ...
    @app.route('/api/config/subgroups', methods=['POST'])
    @login_required
    @admin_required
    def create_config_subgroup():
        data = request.get_json()
        subgroup = Subgroup(
            name=data['name'],
            description=data.get('description', ''),
    ...
    @app.route('/api/config/subgroups/<int:subgroup_id>', methods=['DELETE'])
    @login_required
    @admin_required
    def delete_config_subgroup(subgroup_id):
